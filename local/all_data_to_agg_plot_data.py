...
if __name__ == "__main__":
    ...
    dim = sys.argv[3].lower()
    data_path = file_path + "/resources/" + city + "_data/" + city + "_" + period + "_data.csv"
    ...
    if dim == "group":
        ...
        group_path = file_path + "/resources/" + city + "_data/" + city + "_" + period + "_group_geo.csv"
    ...
    print len(all_df["geo_id"].drop_duplicates())
    sys.exit()
